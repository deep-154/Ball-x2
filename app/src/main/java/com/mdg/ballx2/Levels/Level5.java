...
public class Level5 extends BaseLevel {
    ...
    public Level5(Context context, AttributeSet attributeSet) {
    ...
    public void initializeGame() {
        ...
        Ball b1 = new Ball(initialBallX + 4 * displacement,
                (int) (initialBallY + gameAreaHeight / 10), risingFactor,velocityX);
        Ball b2 = new Ball(initialBallX + 7 * displacement, initialBallY,
    ...
    public void onDraw(Canvas c) {
        ...
        if (numberOfLife > 0) {
            if (balls.isEmpty()) {
                ...
                mlistener.onStageChanged(6,numberOfLife);
                initializeGame();
                updatePowerUps(8);
